...
function Map_parada() {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost/Integradora-2/BACK/rutas/get_paradas',{
            method: 'GET'
        })
    ...
    const HandleSubmit = (event) =>
    {
      ...
      //console.log(event);
        ...
        fetch('http://localhost/Integradora-2/BACK/rutas/insert_parada',
        {
          method: 'POST',
          body: form
        })
    ...
    const HandleDelete = (event) =>
    {
      event.preventDefault();
        ...
        fetch('http://localhost/Integradora-2/BACK/rutas/delete_parada',
        {
          method: 'POST',
          body: formDelete
        })
