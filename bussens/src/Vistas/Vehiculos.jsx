...
const Rutas = () => {
  ...
  useEffect(() => {
    ...
    fetch('http://dtai.uteq.edu.mx/~diemar209/Integradora2/BACK/rutas/get_vehiculos')
  ...
  const Actualizar = e =>
  {
    ...
    const formUpdateVehiculo = new FormData();
        ...
        fetch('http://dtai.uteq.edu.mx/~diemar209/Integradora2/BACK/rutas/update_vehiculo',
        {
          method: 'POST',
  ...
  const Agregar = e =>
  {
    ...
    const formUpdateVehiculo = new FormData();
        ...
        //console.log(formUpdateVehiculo.get('clave'));
        fetch('http://dtai.uteq.edu.mx/~diemar209/Integradora2/BACK/rutas/insert_vehiculo',
        {
          method: 'POST',
          body: formUpdateVehiculo
        })
  ...
  const Eliminar = (clave) =>
  {
    ...
    const formUpdateVehiculo = new FormData();
        ...
        //console.log(formUpdateVehiculo.get('clave'));
        fetch('http://dtai.uteq.edu.mx/~diemar209/Integradora2/BACK/rutas/delete_vehiculo',
        {
          method: 'POST',
          body: formUpdateVehiculo
        })
  ...
  const Guardar = (claveRuta, claveVehiculo, actualizar) =>
  {
    ...
    //(actualizar);
    fetch('http://dtai.uteq.edu.mx/~diemar209/Integradora2/BACK/rutas/' + url,
        {
        method: 'POST',
        body: formGuardar
      })
  ...
  const delete_ruta = (claveVehiculo) =>
  {
    ...
    fetch('http://dtai.uteq.edu.mx/~diemar209/Integradora2/BACK/rutas/delete_ruta_vehiculo',
        {
        method: 'POST',
        body: formEliminar
      })
