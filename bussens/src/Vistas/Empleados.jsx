...
const Empleados = () => {
  ...
  useEffect(() => {
    ...
    fetch('http://dtai.uteq.edu.mx/~diemar209/Integradora2/BACK/empleados/get_empleados')
  ...
  const Actualizar = e =>
  {
    ...
    const formUpdateEmpleado = new FormData();
        ...
        fetch('http://dtai.uteq.edu.mx/~diemar209/Integradora2/BACK/empleados/update_empleado',
        {
          method: 'POST',
  ...
  const Agregar = e =>
  {
    ...
    const formAgregarEmp = new FormData();
        ...
        //console.log(formUpdateVehiculo.get('clave'));
        fetch('http://dtai.uteq.edu.mx/~diemar209/Integradora2/BACK/empleados/insert_empleado',
        {
          method: 'POST',
          body: formAgregarEmp
        })
  ...
  const Eliminar = (clave) =>
  {
    ...
    const formDeleteEmp = new FormData();
        ...
        //console.log(formUpdateVehiculo.get('clave'));
        fetch('http://dtai.uteq.edu.mx/~diemar209/Integradora2/BACK/empleados/delete_empleado',
        {
          method: 'POST',
          body: formDeleteEmp
        })
  ...
  const Guardar = (claveVehiculo, claveChofer, actualizar) =>
  {
    ...
    fetch('http://dtai.uteq.edu.mx/~diemar209/Integradora2/BACK/empleados/' + url,
        {
        method: 'POST',
        body: formGuardar
      })
  ...
  const delete_ruta = (clave) =>
  {
    ...
    fetch('http://dtai.uteq.edu.mx/~diemar209/Integradora2/BACK/empleados/delete_chofer_vehiculo',
        {
        method: 'POST',
        body: formEliminar
      })
